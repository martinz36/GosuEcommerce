...
export function CatalogContainer({
  ...
  return (
    <div className="bg-neutral-50 text-slate-900 min-h-screen font-body">
      {/* Transición de Negro al Lienzo Claro del Catálogo */}
      <div className="h-16 bg-gradient-to-b from-black via-neutral-950 to-neutral-50" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-neutral-200 pb-6">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight uppercase text-slate-900">
          ...
          <button
            ...
            className="lg:hidden flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-xs font-mono font-bold text-white hover:border-cyan-400 transition-colors"
          >
      ...
      <div className="h-16 bg-gradient-to-b from-neutral-50 via-neutral-950 to-black mt-12" />
    </div>
  );
}
