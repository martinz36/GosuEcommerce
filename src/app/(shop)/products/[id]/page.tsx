            ...
            {relatedProducts.map((rel) => (
              <ProductCard
                ...
                product={{
                  ...
                  compareAtPriceUSD: rel.compareAtPriceUSD ? Number(rel.compareAtPriceUSD) : null,
                  compareAtPricePEN: rel.compareAtPricePEN ? Number(rel.compareAtPricePEN) : null,
                  compareAtPrice: rel.compareAtPrice ? Number(rel.compareAtPrice) : null,
                  badgeText: rel.badgeText,
                  isNew: rel.isNew,
                  stock: rel.stock,
                  imageUrl: rel.images?.[0]?.url || null,
                  secondaryImageUrl: rel.images?.[1]?.url || null,
                  images: rel.images,
